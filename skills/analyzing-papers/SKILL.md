...
```bash
# List sessions
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/select_input.py \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/extract_data.py \
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/extract_temporal.py \
  --input <session_path>/deduplicated.json \
...
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/graph_algorithms.py --help

# Run PageRank and Betweenness for comprehensive analysis
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/graph_algorithms.py \
  --input <session_path>/deduplicated.json \
...
```bash
# Check --help for options
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/statistical_tools.py --help

# Citation distribution
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/statistical_tools.py \
  --input <session_path>/deduplicated.json \
...
**Use `--help`**:
```bash
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/extract_data.py --help
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/extract_temporal.py --help
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/graph_algorithms.py --help
python "${CLAUDE_PLUGIN_ROOT}/skills/analyzing-papers/tools/scripts/statistical_tools.py --help
```
